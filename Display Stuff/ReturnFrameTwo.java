...
class ReturnFrameTwo extends JFrame {

 // class variable (non-static)
 static double x, y;
 static ReturnAreaPanel objectivePanel;
 private final BufferedImage objectiveFrame;

 // Constructor - this runs first
 ReturnFrameTwo() throws IOException {
  super("Return");
  ...
  this.setBackground(new Color(0, 800, 0, 150));

  // Set up the game panel (where we put our graphics)
  objectivePanel = new ReturnAreaPanel();
  objectivePanel.setBackground(new Color(0, 65, 200, 150));

  this.add(new ReturnAreaPanel());
...
// End of Constructor
 ...
 // screen occurs
 private class ReturnAreaPanel extends JPanel {
